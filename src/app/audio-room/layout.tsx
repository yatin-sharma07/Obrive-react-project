...
export default function AudioRoomLayout({
  ...
  if (loading) {
    return (
      <div
        className={`${spaceGrotesk.className} min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(7,109,71,0.08),transparent_28%),radial-gradient(circle_at_top_right,rgba(15,23,42,0.06),transparent_24%),linear-gradient(180deg,#f8fafc_0%,#f1f5f9_100%)] text-slate-950`}
      >
  ...
  return (
    <SocketProvider>
      <div className={`${spaceGrotesk.className} min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(7,109,71,0.08),transparent_28%),radial-gradient(circle_at_top_right,rgba(15,23,42,0.06),transparent_24%),linear-gradient(180deg,#f8fafc_0%,#f1f5f9_100%)] text-slate-950`}>
        {children}
      </div>
    </SocketProvider>
  );

...
const Dashboard = ({setActiveSection}:{
    setActiveSection:(key:string)=>void
     ...
     const { events, activities, user, loading, refetch } = useDashboardData('supervisor')
...
>
     <div className="flex h-full min-h-0 flex-col gap-3 overflow-hidden xl:flex-row">
        ...
        <div className="flex w-full flex-col gap-3 overflow-hidden xl:w-80 xl:min-w-[20rem]">
          ...
          <div className="min-h-[220px] bg-white rounded-lg p-3 overflow-y-auto text-black xl:flex-1 xl:min-h-0">
            {/* ActivityStream commented out for supervisor - using dummy OnlinePersons instead */}
            ...
            <div className="flex h-full flex-col">
              ...
              <div className="flex-1 space-y-3">
                {[
                  { name: 'Karn Singh', role: 'Full Stack Developer', status: 'online' },
                  { name: 'Yatin Sharma', role: 'UI/UX Designer', status: 'online' },
                  { name: 'Priya Verma', role: 'Project Manager', status: 'online' },
                ].map((person, idx) => (
                ...
                <p className="text-center text-[10px] text-gray-400 mt-2 italic">
                  Socket integration coming soon...
                </p>
              </div>
            </div>
          </div>
